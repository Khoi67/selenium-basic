...
public class Login01_Verify_Login_Function extends BaseTest {
    ...
    public Object[][] loginCredentialsData() {
        Object[][] data = ExcelUtil.readAllData(System.getProperty("user.dir") + "/src/test/resources/testdata/users_credentials.xlsx", "Sheet1");
        return data;
    }
...
//        String account = "57ed1175-e5d9-47a9-836b-ff28011a57ca";
        ...
        homePage.getTopBarNavigation().waitForLoginLinkDisplayed(TimeOutConstant.DEFAULT_TIMEOUT);
    }
}